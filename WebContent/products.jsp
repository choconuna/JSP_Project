...
<title>PRODUCTS | JIN BAKERY</title>
</head>
<body>
	...
	<div class="jumbotron bg-white">
		<div class="container bg-white">
			<h1 class="display-3 text-center text-info">ALL PRODUCTS</h1>
		</div>
		<hr>
		<div class="container">
	...
	<div class="container">
		<ul class="nav">
			<li class="nav-item"><a class="nav-link" href="./products.jsp">ALL</a></li>
			<li class="nav-item"><a class="nav-link disabled"
				href="./bread.jsp">BREAD</a></li>
			<li class="nav-item"><a class="nav-link disabled"
